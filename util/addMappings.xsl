...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="currentRelease" select="'cio-dataset-200-beta3-20241023'"/>
    <xsl:variable name="currentReleaseUri" select="'https://decor.nictiz.nl/pub/cio/cio-html-20241023T071643/ds-2.16.840.1.113883.2.4.3.11.60.26.1.2-2020-04-02T000000.html'"/>
    <xsl:variable name="currentReleaseName" select="'ART-DECOR Dataset Contraindications and hypersensitivities 2.0.0-beta.3 20241023'"/>
